...
class LocalMedias {
    ...
    func loadList(completionHandler: ()->()) {
        ...
        let assetsFetchResults = PHAsset.fetchAssets(with: self.grabImageAndVideoSortByModifiDateDesc())
    ...
    /* 抓取全部影片與照片，按修改時間倒著排序 */
    func grabImageAndVideoSortByModifiDateDesc() -> PHFetchOptions {
